...
sprite_remove_settings = MenySpriteCreate(None, sprite_setting_menu.rect.x + 20, sprite_setting_menu.rect.y + 190,
...
def save_settings():
    ...
    file_settings.write(str(screen_size1[0]) + " " + str(screen_size1[1]) + '\r')
...
def apply_settings(flag=True):
    global return_settings, fps, volume, fuel_screen, screen_size1, days_to_save, enter_size, enter_fps, enter_days_of_save
    if flag:
...
def render_setting(screen):
    ...
    if sprite_setting_menu.visible:
        ...
        if sprite_setting_menu.visible:
            for index in range(11):
                ...
                pygame.draw.rect(screen, color,
                                 (sprite_down_volume.rect.x + 50 + (index * 24), sprite_down_volume.rect.y, 17, 45))
        ...
        screen.blit(pygame.font.Font(None, 26).render(
            (str(screen_size1[0]) + 'x' + str(float(screen_size1[0]) * 1.92)), True, (0, 0, 0)),
            (sprite_input_screen_size.rect.x + 10, sprite_input_screen_size.rect.y + 5))
